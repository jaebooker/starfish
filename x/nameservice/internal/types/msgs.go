...
// NewMsgSetName is a constructor function for MsgSetName
func NewMsgSetVote(name string, value string, owner sdk.AccAddress, votes int) MsgSetName {
	return MsgSetVote{
		Name:  name,
		Value: value,
		Owner: owner,
...
// Route should return the name of the module
func (msg MsgSetVote) Route() string { return RouterKey }
...
func NewMsgVote(name string, vote int, voter sdk.AccAddress) MsgVote {
	return MsgVote{
		Name:  name,
		Vote: int,
		Voter: voter,
